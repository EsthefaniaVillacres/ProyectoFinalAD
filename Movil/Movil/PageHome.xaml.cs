...
namespace Movil
{
    ...
    public partial class PageHome : ContentPage
    {
        ...
        public PageHome()
        {
            ...
            //NotificationCenter.Current.NotificationActionTapped += OnLocalNotificationActionTapped;
        ...
        private void OnLocalNotificationTapped(NotificationEventArgs e)
        {
            ...
            {
                await Navigation.PushAsync(new Map(id));
            });
        }

        private void GetUser()
        {
            labelBienvenido.Text += result.USER_USER;
            labelSucursal.Text += result.OFFICE_USER;
